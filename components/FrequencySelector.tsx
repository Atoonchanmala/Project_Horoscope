...
import { FrequencyType } from '@/types/horoscope';
    ...
    <div className="space-y-8">
      ...
      >
        <div className="flex items-center justify-center gap-2 mb-2">
          ...
          <h2 className="text-[#F7EDEA] text-2xl font-semibold">Choose Your Reading Frequency</h2>
        </div>
            ...
            >
              ...
              >
                ...
                <div className="text-center space-y-2">
                  <h3 className="text-[#F7EDEA] text-lg font-semibold">{frequency.title}</h3>
